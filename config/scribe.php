...
return [
    ...
    'laravel' => [
        ...
        // You can add middleware here, e.g., ['auth'] to restrict docs access to authenticated users only.
        // You may also use authorization middleware for more granular access control.
        'middleware' => [],
    ],
    ...
    'openapi' => [
        ...
        'generators' => [
            ...
            \App\Scribe\OpenApiGenerator::class,
        ],
    ],
    ...
    'strategies' => [
        'metadata' => [
            ...
            JsonApiStrategies\Metadata\GetFromResourceMetadataAttribute::class,
        ],
        'headers' => [
            ...Defaults::HEADERS_STRATEGIES,
            JsonApiStrategies\Headers\GetFromResourceAttributes::class,
        ],
        'urlParameters' => [
            ...Defaults::URL_PARAMETERS_STRATEGIES,
            JsonApiStrategies\UrlParameters\GetFromResourceRequestAttributes::class,
        ],
        'queryParameters' => [
            ...Defaults::QUERY_PARAMETERS_STRATEGIES,
            JsonApiStrategies\QueryParameters\GetFromResourceRequestAttributes::class,
        ],
        'bodyParameters' => [
    ...
    // Custom route matcher for dynamic routes (JSON:API)
